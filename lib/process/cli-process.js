  ...
  async _spawnTmuxClaude({ tmuxName, opts }) {
    ...
    claudeArgs.push('--append-system-prompt', [
      ...
      ...(this.streamToolEnabled ? [
        ...
        'their caption text. When your answer includes media, stream ONLY the',
        'prose: do NOT stream a message that carries media. Deliver the media in',
        'its own separate reply alongside the report.',
        '',
      ] : []),
