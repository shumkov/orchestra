  ...
  async _spawnTmuxClaude({ tmuxName, opts }) {
    ...
    claudeArgs.push('--append-system-prompt', [
      ...
      ...(this.streamToolEnabled ? [
        ...
        'were writing.',
        '',
        'So if your answer will run longer than about two paragraphs, then after',
        'EVERY section you finish and BEFORE you start writing the next one,',
        `you MUST call \`mcp__${b}__stream\` with the FULL answer-so-far.`,
        'Not once at the end, not "at a natural checkpoint" — after each section,',
